    ...
    `}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4">
          ...
          {/* User Actions - Quick Icons */}
          {/*<div className="flex items-center space-x-2">
            {/* Wishlist Icon *
            <Link
              href="/wishlist"
              className="relative p-2 text-[var(--color-text)] hover:text-[var(--color-primary)] rounded-lg hover:bg-[var(--color-primary-soft)]/30 transition-all"
            >
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              {/* User Dropdown Menu *
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-[var(--color-surface)] rounded-xl shadow-2xl border border-[var(--color-border)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  {user ? (
                    <>
                      <div className="p-4 border-b border-[var(--color-border)]">
                        ...
                        <span className="inline-block mt-2 px-2 py-1 text-xs rounded-full bg-[var(--color-primary-soft)] text-[var(--color-primary)] capitalize">
                          {user.role}
                        </span>
                      </div>
                      <div className="py-2">
                        <Link
                          href="/profile"
                          className="flex items-center space-x-3 px-4 py-2 text-[var(--color-text)] hover:bg-[var(--color-primary-soft)]/30 transition-colors"
                        ...
                        <button
                          ...
                          className="flex items-center space-x-3 w-full px-4 py-2 text-red-500 hover:bg-red-50 transition-colors"
                        >
                          <LogOut className="w-4 h-4" />
                          <span>Sign Out</span>
                        </button>
                    ...
                    <div className="p-4">
                      <Link
                        href="/login"
                        className="block w-full text-center px-4 py-2 bg-[var(--color-primary)] text-white rounded-lg hover:bg-[var(--color-primary-hover)] transition-colors"
                        onClick={() => setUserMenuOpen(false)}
                      >
                        Sign In
                      </Link>
                      <Link
                        href="/register"
                        className="block w-full text-center mt-2 px-4 py-2 border border-[var(--color-border)] text-[var(--color-text)] rounded-lg hover:bg-[var(--color-primary-soft)]/30 transition-colors"
                        onClick={() => setUserMenuOpen(false)}
                      >
                        Create Account
                      </Link>
