...
export default function ShopsTab() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header *
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Discover Shops</h1>
        ...
        <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-lg focus:ring-2 focus:ring-[#bf2c7e] focus:border-[#bf2c7e]"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 text-gray-700 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#bf2c7e] focus:border-[#bf2c7e]"
            />
          </div>
          ...
          <div className="flex items-end">
            <button
              type="submit"
              className="w-full bg-[#182155] text-white px-6 py-2 rounded-lg hover:bg-[#0f183f] transition-colors font-medium"
            >
              Apply Filters
            </button>
          </div>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
            {shops.map((shop) => (
              ...
              >
                {/* Shop Banner *
                <div className="h-32 bg-[#bf2c7e] relative overflow-hidden">
                  {shop.banner ? (
                    <Image
                      src={shop.banner}
