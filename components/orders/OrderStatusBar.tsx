...
export interface StatusBarSuborder {
  ...
  netAmount: number;
  deliveryFee?: number;
  // FIX: Allow both string and ObjectId (or use 'any' if you don't have mongoose types)
  riderId?: string | Types.ObjectId | undefined;
  // ALTERNATIVE if mongoose types aren't available:
  // riderId?: string | { toString(): string } | undefined;
  deliveryDetails?: {
    confirmationCode?: string;
    confirmedAt?: string;
    riderConfirmedAt?: string;
