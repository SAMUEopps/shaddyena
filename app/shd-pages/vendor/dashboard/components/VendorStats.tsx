...
// app/shd-pages/vendor/components/VendorStats.tsx
'use client';
...
function StatCard({ label, value, icon, iconBg, href }: StatCardProps) {
  ...
  if (href) {
    return (
      <Link href={href} className="block cursor-pointer hover:opacity-80 transition-opacity">
        {content}
      </Link>
    );
  }
...
export default function VendorStats({ 
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: '💰',
      iconBg: 'bg-green-100',
      href: '/shd-pages/vendor/revenue' // Link to revenue page
    },
    {
      label: 'Available Balance',
      value: `KSh ${availableBalance.toLocaleString()}`,
      icon: '💳',
      iconBg: 'bg-emerald-100',
      href: '/shd-pages/vendor/revenue'
    },
    {
