...
export default function ProductCard({ product, onAddToCart, isAdding }: ProductCardProps) {
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    ...
    router.push(`/shd-pages/products/${product._id}`);
  };

  return (
    <div 
      className="bg-white rounded-xl sm:rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-surface hover:border-primary/20 group h-full flex flex-col cursor-pointer"
