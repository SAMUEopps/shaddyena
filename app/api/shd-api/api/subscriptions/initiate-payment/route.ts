...
//     // ⚠️ IMPORTANT: Get organizationId from the vendor or user
//     // The Transaction schema REQUIRES organizationId
//     const organizationId = vendor.organizationId;
    
//     if (!organizationId) {
//       return NextResponse.json(
//         { error: 'Organization not found. Please complete your organization setup.' },
//         { status: 400 }
//       );
//     }
