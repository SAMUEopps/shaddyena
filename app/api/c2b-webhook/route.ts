...
// //   try {
// //     console.log(`🔄 Processing membership payment for transaction: ${transaction._id}`);
...
//       //   console.log(`✅ STK Payment successful! Receipt: ${receiptNumber}, Amount: ${amount}`);
...
//      processed =
//      await processInvestmentPayment(
//        transaction,
//        receiptNumber
//      );
...
//       // Decode the MSISDN if it's hashed
//       let phoneNumber = MSISDN;
//       // If the MSISDN is hashed (looks like a hash), try to get it from the transaction
...
//       if (!transaction) {
//         // The checkoutRequestId might be stored in metadata
//         transaction = await Transaction.findOne({ 
