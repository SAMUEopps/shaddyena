...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ShopEase | Multi-Vendor Marketplace</title>
        ...
        <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          <div className="flex flex-col flex-grow bg-[#182155] pt-5 pb-4 overflow-y-auto">
            ...
            <div className="flex items-center flex-shrink-0 px-4">
              <div className="w-8 h-8 bg-[#ff199c] rounded-full grid place-items-center">
                <span className="text-white font-bold">S</span>
              </div>
              <h1 className="ml-2 text-white text-xl font-bold">ShopEase</h1>
            </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 rounded-lg transition-colors ${
                    activeTab === item.id
                      ...
                      : 'text-gray-200 hover:bg-[#ff199c] hover:text-white'
                  }`}
                >
            ...
            <div className="px-4 mt-auto space-y-4">
              <div className="bg-[#0f183f] text-white p-4 rounded-lg">
                ...
                <button
                  ...
                  className="mt-3 w-full bg-[#ff199c] text-white py-2 rounded-md text-sm font-semibold"
                >
                  Get Help
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-40 lg:hidden">
            ...
            <aside className="relative max-w-full w-64 h-full bg-[#182155] flex flex-col">
              ...
              <div className="flex items-center px-4 pt-5">
                <div className="w-8 h-8 bg-[#ff199c] rounded-full grid place-items-center shrink-0">
                  <span className="text-white font-bold">S</span>
                </div>
                <h1 className="ml-2 text-white text-xl font-bold break-words">ShopEase</h1>
                <button
                  type="button"
                  ...
                  <div className="ml-4 lg:ml-0 w-full lg:max-w-sm">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-[#ff199c] focus:border-[#ff199c] sm:text-sm"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                {wishlistItems.length > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#ff199c] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
              ...
              <Link href="/profile" className="relative cursor-pointer">
                <div className="w-10 h-10 bg-[#ff199c] rounded-full grid place-items-center text-white font-semibold break-all">
